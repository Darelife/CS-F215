...
def main():
    # File paths
    verilog_file_decoder = "testbench_decoder.v"      # Verilog testbench file for 4:16 decoder
    verilog_file_palindrome = "testbench_palindrome.v"      # Verilog testbench file for palindrome
    verilog_file_latch = "testbench_SR_latch.v"      # Verilog testbench file for latch
    ...
    # Step 1: Run the Verilog simulation for 4:16 decoder
    if run_verilog_simulation(verilog_file_decoder, output_file):
    ...
    if run_verilog_simulation(verilog_file_palindrome, output_file):
        # Step 2: Read the simulation output
        sim_output = read_output(output_file)
    ...
    if run_verilog_simulation(verilog_file_latch, output_file):
        # Step 2: Read the simulation output
        sim_output = read_output(output_file)
